...
x = Dense(intermediate_dim, activation='relu', name='decoder_middle')(latent_inputs)
...
if __name__ == '__main__':
    ...
    export_model(tf.train.Saver(), decoder,"mnist2_decoder784", ['decoder_input'], "decoder_output/Sigmoid")
